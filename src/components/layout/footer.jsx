...
const Footer = () => {
  ...
  return (
    ...
    <footer className="bg-white dark:bg-[#0B0C10] text-[#191970] dark:text-white py-16 px-6 lg:px-24 overflow-hidden transition-colors duration-500">
      ...
      <motion.div 
        ...
        className="max-w-7xl mx-auto bg-[#191970] dark:bg-[#12141A] text-white backdrop-blur-xl border border-white/10 dark:border-white/5 rounded-2xl p-10 md:p-16 shadow-[0_8px_32px_rgba(0,0,0,0.3)] transition-colors duration-500"
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-24">
          ...
          <motion.div variants={itemVariants} className="flex flex-col space-y-6">
            <div className="flex items-center space-x-3">
              <span className="font-primary font-bold text-3xl tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-[#D4AF37]">GTS</span>
              <span className="font-primary font-medium tracking-wide text-white">Grand Tech Solutions</span>
            </div>
            <p className="font-secondary text-gray-300 dark:text-gray-400 leading-editorial max-w-sm text-sm">
          ...
          <motion.div variants={itemVariants} className="flex flex-col space-y-4 font-primary text-sm tracking-widest uppercase">
            <h4 className="text-xs text-gray-500 dark:text-gray-400 mb-2">Explore</h4>
            ...
            <a href="/privacy-policy" className="text-white hover:translate-x-2 transition-all duration-300 w-fit mt-4 text-xs">Privacy Policy</a>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="flex flex-col space-y-4 font-primary text-sm tracking-widest uppercase text-left md:text-right">
            <h4 className="text-xs text-gray-500 dark:text-gray-400 mb-2 md:text-right">Connect</h4>
        ...
        {/* Bottom Bar */}
        <motion.div variants={itemVariants} className="mt-16 pt-8 border-t border-white/10 dark:border-white/5 flex flex-col md:flex-row justify-between items-center text-xs text-gray-300 dark:text-gray-500 font-primary tracking-widest uppercase">
